...
describe('Service Tests', () => {
    ...
    describe('DemandeChangementRbsmr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DemandeChangementRbsmrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/demande-changements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return DemandeChangementRbsmr', () => {
