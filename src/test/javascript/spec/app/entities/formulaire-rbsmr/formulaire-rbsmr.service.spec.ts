...
describe('Service Tests', () => {
    ...
    describe('FormulaireRbsmr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FormulaireRbsmrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/formulaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return FormulaireRbsmr', () => {
