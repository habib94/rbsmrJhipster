...
describe('Service Tests', () => {
    ...
    describe('EtatFormulaireRbsmr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EtatFormulaireRbsmrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/etat-formulaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EtatFormulaireRbsmr', () => {
