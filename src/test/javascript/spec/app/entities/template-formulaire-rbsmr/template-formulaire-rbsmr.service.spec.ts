...
describe('Service Tests', () => {
    ...
    describe('TemplateFormulaireRbsmr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TemplateFormulaireRbsmrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/template-formulaires';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TemplateFormulaireRbsmr', () => {
