...
describe('Service Tests', () => {
    ...
    describe('QuestionValidationRbsmr Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(QuestionValidationRbsmrService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/question-validations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuestionValidationRbsmr', () => {
