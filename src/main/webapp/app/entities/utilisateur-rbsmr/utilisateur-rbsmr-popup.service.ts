...
@Injectable()
export class UtilisateurRbsmrPopupService {
            ...
            if (id) {
                this.utilisateurService.find(id)
                    .subscribe((utilisateurResponse: HttpResponse<UtilisateurRbsmr>) => {
                        const utilisateur: UtilisateurRbsmr = utilisateurResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.utilisateurModalRef(component, new UtilisateurRbsmr());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    utilisateurModalRef(component: Component, utilisateur: UtilisateurRbsmr): NgbModalRef {
